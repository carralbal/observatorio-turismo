...
const RobotIcon = () => (
  <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#FAFAF7" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <rect x="3" y="8" width="18" height="12" rx="2" />
    <path d="M9 12h.01M15 12h.01" strokeWidth="2.5" />
    <path d="M9 16h6" />
    <path d="M12 8V5" />
    <circle cx="12" cy="4" r="1.2" fill="#FAFAF7" stroke="none" />
